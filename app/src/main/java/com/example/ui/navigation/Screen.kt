...
sealed class Screen(val route: String, val titleTr: String, val titleEn: String, val icon: ImageVector? = null) {
    ...
    object TrackingMap : Screen("tracking_map", "Konum & Rota", "Tracking & Map", Icons.Default.Map)
    object EventLogs : Screen("event_logs", "Olay Kayıtları", "Event Logs", Icons.Default.History)
    object LeaveRequests : Screen("leave_requests", "İzin Talepleri", "Leave Requests", Icons.Default.Assignment)
